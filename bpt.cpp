    ...
    if (node.n < min_n)
    {
        ...
        if (!borrowed)
        {
            ...
            if (offset = (end(parent) - 1)->child)
            {
                ...
                index_t *where = find(parent, begin(prev)->child);
...
/*
    ...
    *******
*/
int bpt::insert(key_t &key, value_t value)
{
...
//在内部结点中添加新的索引项
void bpt::insert_key_to_index(off_t offset, key_t &key,
...
/*
    ...
    *******
*/
int bpt::update(key_t key, value_t value)
{
